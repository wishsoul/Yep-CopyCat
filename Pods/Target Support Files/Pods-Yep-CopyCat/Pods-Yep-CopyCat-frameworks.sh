...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/APAddressBook/APAddressBook.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Alamofire/Alamofire.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Base64/Base64.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/DeviceGuru/DeviceGuru.framework"
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/KeyboardMan/KeyboardMan.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Kingfisher/Kingfisher.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/MonkeyKing/MonkeyKing.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Navi/Navi.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/Proposer/Proposer.framework"
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/Ruler/Ruler.framework"
