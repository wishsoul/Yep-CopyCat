...
class ShowStepViewController: UIViewController {
    ...
    @IBOutlet private weak var subTitleLableBottomconstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        subTitleLableBottomconstraint.constant = Ruler.iPhoneVertical(120, 140, 160, 180).value
    }
